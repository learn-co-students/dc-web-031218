...
function tellStoryWithSetTimeout() {
  // intros
  setTimeout(() => {
            ...
            setTimeout(() => {
              ...
              setTimeout(() => {
                ...
                setTimeout(() => {
                  ...
                  colorLog(nymeria, STEEL);
                  colorLog(
                    `"Just hanging out!" Nymeria responded. "Wanna play fetch?"`,
                    STEEL
                  );
                  colorLog(floof, ORANGE);
                  colorLog(
                  ...
                  colorLog(floof, ORANGE);
                  colorLog(
                    `"Sure thing, Speedy! I love to help out however I can."`,
                    ORANGE
                  );
                  colorLog("Nymeria and Floof went off to the store", INDIGO);
                  colorLog(ghost, GREEN);
                  colorLog(
                    `"Nice thinking, Speedy! I thought we were made for sure!"`,
                    GREEN
                  );
                  ...
                  colorLog(
                    "\n Floof was shocked, then laughed with delight!",
                    INDIGO
                  );
                  ...
                  colorLog(
                    `"Oh, shucks, friends, I couldn't have asked for more!"`,
                    ORANGE
                  );
...
// tellStoryWithSetTimeout();

// we want to return a Promise - the future value of our function
function waitAndThen(seconds, func) {
...
// waitAndThen(1, doIntros).then((() => waitAndThen(2, episodeTitle)).then(waitAndThen(3, firstPart))

let promise = waitAndThen(1, () => "Hello, promises");
